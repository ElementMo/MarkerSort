...
namespace RenderHeads.Media.AVProVideo
{
	...
	public interface IMediaControl
	{
		...
		/// </summary>
		bool	OpenVideoFromFile(string path, long offset, string httpHeaderJson, uint sourceSamplerate = 0, uint sourceChannels = 0);
	...
	{
		public const string ScriptVersion = "1.8.5";
